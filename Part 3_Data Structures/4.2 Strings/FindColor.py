...
def find_color(a_string):
    a_string = a_string.strip("rgb()")
    color_list = a_string.split(", ")
    red_val = int(color_list[0])
    green_val = int(color_list[1])
    blue_val = int(color_list[2])
