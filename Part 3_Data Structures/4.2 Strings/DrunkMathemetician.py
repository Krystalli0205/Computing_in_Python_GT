...
def to_metric(a_string):
    list = a_string.split(" ")
    if list[1] == "gallons":
        return round(float(list[0]) * 3785.41, 2)
    if list[1] == "quarts":
        return round(float(list[0]) * 946.35, 2)
    if list[1] == "pints":
        return round(float(list[0]) * 473.18, 2)
    if list[1] == "cups":
        return round(float(list[0]) * 240, 2)
    if list[1] == "ounces":
        return round(float(list[0]) * 29.57, 2)
    if list[1] == "tablespoons":
        return round(float(list[0]) * 14.79, 2)
    if list[1] == "teaspoons":
        return round(float(list[0]) * 4.93, 2)
