...
def most_active(dict_lists):
    most_active_stu = None
    highest_activity = -1

    for list in dict_lists:
        if list["days_active"] > highest_activity:
            most_active_stu = list["name"]
            highest_activity = list["days_active"]
    
    return most_active_stu
