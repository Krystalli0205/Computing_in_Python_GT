...
money = (can_afford and destination_is_safe) or (not can_afford and destination_is_safe and (educational_value or relatives_nearby))
transportation = (is_international and have_passport and not afraid_to_fly) or (not is_international and (have_a_car or not afraid_to_fly))
beach = is_a_beach and is_warm
skiing = has_skiing and not is_warm
city = is_a_city and (is_off_peak or has_attraction)
b_c = beach or city
s_c = skiing or city
destination = beach or skiing or city or b_c or s_c
result = money and transportation and destination
print(result)
