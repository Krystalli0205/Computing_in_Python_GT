...
if exam:
    ...
    res = sunblock and morning_classes or night_classes
elif raining:
    res = rain_jacket
elif snowing:
    res = (friends_are_going and fluffy_coat) or (snow_boots and fluffy_coat) or (really_want_to_go)
else:
    res = False
print("True or false: I should go to class:", str(res))