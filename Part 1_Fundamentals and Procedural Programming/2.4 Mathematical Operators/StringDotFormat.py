...
#Add your code here!
sum = mystery_value_1 + mystery_value_2
diff = mystery_value_1 - mystery_value_2
product = mystery_value_1 * mystery_value_2
quo = mystery_value_1 / mystery_value_2
print("The sum is " + str(sum) + ", the difference is " + str(diff) + ", the product is " + str(product) + ", and the quotient is " + str(quo) + ".")