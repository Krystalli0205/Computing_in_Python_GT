...
def binary_tree_search(node, search_val):
    if node == None:
        return False
    ...
    elif node.value < search_val:
        return binary_tree_search(node.right, search_val)
    
    else:
        return binary_tree_search(node.left, search_val)
