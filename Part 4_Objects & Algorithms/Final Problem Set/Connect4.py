...
def count_4_executives(list_4):
    if list_4[0] and list_4.count(list_4[0]) == 4:
        return list_4[0]
    return None
...
def check_winner(list):
    ...
    for i in range(rows):
        for j in range(cols-3):
            winner = count_4_executives([list[i][j], list[i][j+1], list[i][j+2], list[i][j+3]])
            if winner:
                return winner
    ...
    for j in range(cols):
        for i in range(rows - 3):
            winner = count_4_executives([list[i][j], list[i+1][j], list[i+2][j], list[i+3][j]])
            if winner:
                return winner
            
    # check diagnally (top-left to bottom-right)
    for i in range(rows-3):
        for j in range(cols-3):
            winner = count_4_executives([list[i][j], list[i+1][j+1], list[i+2][j+2], list[i+3][j+3]])
            if winner:
                return winner
            
    # check diagnally (bottom-left to top-right)
