...
def to_dictionaries(nation_list):
    ...
    for nation in nation_list:
        feature = {}
        feature["long_name"] = nation.long_name
        feature["iso_code"] = nation.iso_code
        feature["iso_short"] = nation.iso_short
        feature["iso_long"] = nation.iso_long
        feature["capital"] = nation.capital
        res[nation.short_name] = feature
    return res
