...
binary_res += str(number // 128)
number %= 128

binary_res += str(number // 64)
number %= 64

binary_res += str(number // 32)
number %= 32

binary_res += str(number // 16)
number %= 16

binary_res += str(number // 8)
number %= 8

binary_res += str(number // 4)
number %= 4

binary_res += str(number // 2)
number %= 2

binary_res += str(number // 1)
number %= 1
