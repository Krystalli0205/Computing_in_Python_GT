...
#Add your code here!
sum_grade = grade + curve

if sum_grade > 100:
    sum_grade = 100

if sum_grade >= 90:
    print("Congratulations! Your final grade is {}, an A.".format(sum_grade))
elif sum_grade >= 80:
    print("Good job! Your final grade is {}, a B.".format(sum_grade))
elif sum_grade >= 70:
    print("Not bad! Your final grade is {}, a C.".format(sum_grade))
elif sum_grade >= 60:
    print("You passed! Your final grade is {}, a D.".format(sum_grade))
else:
    print("It's just one grade. Your final grade is {}, an F.".format(sum_grade))